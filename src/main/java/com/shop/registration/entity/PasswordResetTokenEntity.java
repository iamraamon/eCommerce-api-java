...
public class PasswordResetTokenEntity {
    ...
    @JoinColumn(name = "user_token_id",nullable = false,foreignKey = @ForeignKey(name = "FK_USER_PASSWORD_TOKEN"))
    private UserEntity userEntity;

    public PasswordResetTokenEntity(UserEntity userEntity, String token){
        super();
